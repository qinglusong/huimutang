<?php /* Smarty version 2.6.26, created on 2018-08-12 10:04:22
         compiled from mshow.htm */ ?>
...
">
   ...
   <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
    ...
    <tr>
     <td width="350" valign="top"><form action="mshow.php?rec=<?php if ($this->_tpl_vars['show']): ?>update<?php else: ?>insert<?php endif; ?>"<?php if ($this->_tpl_vars['show']): ?> class="formEdit"<?php endif; ?> method="post" enctype="multipart/form-data">
       <div class="formBasic">
        <dl>
...
<?php else: ?>50<?php endif; ?>" size="20" class="inpMain" />
        ...
        <dl>
         ...
         <a href="mshow.php" class="btnGray"><?php echo $this->_tpl_vars['lang']['cancel']; ?>
</a>
...
" width="100" /></a></td>
        ...
        <td align="center"><a href="mshow.php?rec=edit&id=<?php echo $this->_tpl_vars['show_list']['id']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a> | <a href="mshow.php?rec=del&id=<?php echo $this->_tpl_vars['show_list']['id']; ?>
