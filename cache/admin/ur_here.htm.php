<?php /* Smarty version 2.6.26, created on 2018-08-11 22:11:04
...
<div id="handle"> <!-- 当前位置 -->
 <ul>
  <li class="dropMenu"><a href="JavaScript:void(0);" class="drop"><i></i><em><?php echo $this->_tpl_vars['lang']['top_add']; ?>
   ...
   <div class="menu"><?php if ($this->_tpl_vars['lang']['top_add_product']): ?><a href="product.php?rec=add"><?php echo $this->_tpl_vars['lang']['top_add_product']; ?>
