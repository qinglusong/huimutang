<?php /* Smarty version 2.6.26, created on 2018-08-12 12:42:42
...
" />
    ...
    <a class="btnGray" href="article.php?rec=xiangmuzixun_sort&act=handle"><?php echo $this->_tpl_vars['lang']['sort_close']; ?>
</a>
    <?php else: ?>
    <a class="btnGray" href="article.php?rec=xiangmuzixun_sort&act=handle">开始筛选项目咨询资讯</a>
    <?php endif; ?>
...
?>
      <li>
       ...
       <a href="article.php?rec=xiangmuzixun_sort&act=cancel&id=<?php echo $this->_tpl_vars['article']['id']; ?>
" title="<?php echo $this->_tpl_vars['lang']['sort_cancel']; ?>
">X</a>
      </li>
      <?php endforeach; endif; unset($_from); ?>
...
"><?php echo $this->_tpl_vars['lang']['sort_btn']; ?>
	   ...
	   <?php elseif ($this->_tpl_vars['xiangmuzixun_sort']['xiangmuzixun_handle']): ?>
		 <a href="article.php?rec=xiangmuzixun_sort&act=set&id=<?php echo $this->_tpl_vars['article']['id']; ?>
">咨询页显示</a>
       <?php else: ?>
      ...
      <dl>
       ...
       <dd>
        ...
        <div id="contentFile" class="fileBox">
         <span class="btnFile" onclick="fileBox('content');"><?php echo $this->_tpl_vars['lang']['file_insert_image']; ?>
</span>
         <span class="fileStatus" style="display:none"><img src="images/loader.gif" alt="uploading"/></span>
        </div>
        <!-- /FileBox -->
        <!-- TinyMCE -->
